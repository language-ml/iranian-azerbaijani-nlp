...
def plot_heatmap(
    ...
    ax.set_xticklabels([get_display(arabic_reshaper.reshape(x)) for x in column_labels], minor=False, rotation="vertical")
    ax.set_yticklabels([get_display(arabic_reshaper.reshape(x)) for x in row_labels], minor=False)
